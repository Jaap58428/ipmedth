/**
 * ngokevin v1.1.0 - May 11, 2019 
 * https://github.com/supermedium/aframe-environment-component/commits/master
 */
! function (e) {
    function t(i) {
    ...
    AFRAME.registerComponent("environment", {
        ...
        init: function () {
            this.STAGE_SIZE = 200, this.assets = {
                arches: [{
                    type: "mesh",
        ...
        getFogColor: function (e, t) {
            var r;
            if ("color" == e || "none" == e) r = new THREE.Color(this.data.skyColor);
        ...
        update: function (e) {
            if (!e || void 0 === e.preset || e.preset !== this.data.preset) {
                ...
                if (e && void 0 !== e.preset || Object.assign(t, this.el.components.environment.attrValue), this.el.setAttribute("environment", t), e) return;
                e = {}
            }
            var r = this.data.skyType,
                i = new THREE.Vector3(this.data.lightPosition.x, this.data.lightPosition.y, this.data.lightPosition.z);
            if (i.normalize(), this.sunlight) {
                if (this.sunlight.setAttribute("position", this.data.lightPosition), "atmosphere" != r) {
            ...
            if (r != e.skyType || this.data.skyColor != e.skyColor || this.data.horizonColor != e.horizonColor) {
                ...
                } [r], this.stars && this.stars.setAttribute("visible", "atmosphere" == r), "color" == r ? (s.color = this.data.skyColor, s.fog = !1) : "gradient" == r && (s.topColor = this.data.skyColor, s.bottomColor = this.data.horizonColor), this.sky.setAttribute("material", s)
            }
            "atmosphere" == r && (this.sky.setAttribute("material", {
                sunPosition: i
            }), this.setStars(2e3 * (1 - Math.max(0, 8 * (i.y + .08))))), this.data.fog > 0 ? this.el.sceneEl.setAttribute("fog", {
            ...
            }), this.sunlight.setAttribute("visible", "none" !== this.data.lighting), this.hemilight.setAttribute("visible", "none" !== this.data.lighting);
            var a = !this.groundGeometry || this.data.seed != e.seed || this.data.ground != e.ground || this.data.playArea != e.playArea || this.data.flatShading != e.flatShading;
            (a || this.data.groundColor != e.groundColor || this.data.groundColor2 != e.groundColor2 || this.data.groundYScale != e.groundYScale || this.data.groundTexture != e.groundTexture || this.data.gridColor != e.gridColor || this.data.grid != e.grid) && (this.updateGround(a), this.hemilight && this.hemilight.setAttribute("light", {
                groundColor: this.data.groundColor
            })), this.data.seed == e.seed && this.data.dressingOnPlayArea == e.dressingOnPlayArea && this.data.dressing == e.dressing && this.data.flatShading == e.flatShading && this.data.dressingAmount == e.dressingAmount && this.data.dressingScale == e.dressingScale && this.data.dressingColor == e.dressingColor && this.data.dressingVariance.x == e.dressingVariance.x && this.data.dressingVariance.y == e.dressingVariance.y && this.data.dressingVariance.z == e.dressingVariance.z && this.data.dressingUniformScale == e.dressingUniformScale || this.updateDressing(), this.sky.setAttribute("visible", "none" !== r), this.el.setAttribute("visible", this.data.active), this.data.active || (this.userFog ? this.el.sceneEl.setAttribute("fog", this.userFog) : this.el.sceneEl.removeAttribute("fog")), this.dumpParametersDiff()
        },
        logPreset: function () {
            var e = "{";
            for (var t in this.schema)
                if ("preset" != t) {
                    ...
                    e += "vec3" == r ? "{ x: " + this.data[t].x + ", y: " + this.data[t].y + ", z: " + this.data[t].z + "}" : "string" == r || "color" == r ? '"' + this.data[t] + '"' : this.data[t], e += ", "
                } e += "}", console.log(e)
        },
        dumpParametersDiff: function () {
            ...
            for (var i in this.schema)
                if (!("preset" == i || r && void 0 === r[i])) {
                    ...
                    if ("vec3" == a) {
                        var n = o;
                        "string" == typeof o && (o = o.split(" "), n = {
                            x: o[0],
                            y: o[1],
                            z: o[2]
                        }), e(n.x) == e(s.x) && e(n.y) == e(s.y) && e(n.z) == e(s.z) || t.push(i + ": " + e(s.x) + " " + e(s.y) + " " + e(s.z))
                    } else o != s && ("number" == this.schema[i].type && (s = e(s)), t.push(i + ": " + s))
                } console.log("%c" + t.join("; "), "color: #f48;font-weight:bold")
        },
        random: function (e) {
            return parseFloat("0." + Math.sin(9999 * this.data.seed * e).toString().substr(7))
        },
        updateGround: function (e) {
            ...
            if (e) {
                ...
                for (var o = new r, s = this.groundGeometry.vertices, a = this.groundGeometry.vertices.length, n = 10, d = n / t, l = 0, h = 0, g = 0; l < a; l++)
                    if ("flat" != this.data.ground) {
                        ...
                        switch (this.data.ground) {
                            case "hills":
                                ...
                                break;
                            case "canyon":
                                c = .2 + .8 * o.noise(h, g, 0), c = Math.min(1, 10 * Math.pow(c, 2));
                                break;
                            case "spikes":
                                c = this.random(l) < .02 ? this.random(l + 1) : 0;
                                break;
                            case "noise":
                                c = this.random(l) < .35 ? this.random(l + 1) : 0
                        }
                        c += .1 * this.random(l + 2);
                        var u = 2 * h / n - 1,
                            m = 2 * g / n - 1,
                            f = this.data.playArea;
                        u = Math.max(0, Math.min(1, (Math.abs(u) - (f - .9)) * (1 / f))), m = Math.max(0, Math.min(1, (Math.abs(m) - (f - .9)) * (1 / f))), c *= u > m ? u : m, c < .01 && (c = 0), s[l].z = c, h += d, h >= 10 && (h = 0, g += d)
                    } else s[l].z = 0;
                this.groundGeometry.computeFaceNormals(), this.data.flatShading ? this.groundGeometry.computeFlatVertexNormals() : this.groundGeometry.computeVertexNormals(), this.groundGeometry.verticesNeedUpdate = !0, this.groundGeometry.normalsNeedUpdate = !0
            }
            ...
            var p = 2048,
                y = 20,
                v = this.STAGE_SIZE / y;
            this.groundCanvas && this.groundCanvas.width == p || (this.gridCanvas = document.createElement("canvas"), this.gridCanvas.width = p, this.gridCanvas.height = p, this.gridTexture = new THREE.Texture(this.gridCanvas), this.gridTexture.wrapS = THREE.RepeatWrapping, this.gridTexture.wrapT = THREE.RepeatWrapping, this.gridTexture.repeat.set(v, v), this.groundCanvas = document.createElement("canvas"), this.groundCanvas.width = p, this.groundCanvas.height = p, this.groundTexture = new THREE.Texture(this.groundCanvas), this.groundTexture.wrapS = THREE.RepeatWrapping, this.groundTexture.wrapT = THREE.RepeatWrapping, this.groundTexture.repeat.set(v, v), this.groundMaterialProps = {
                map: this.groundTexture,
                emissive: new THREE.Color(16777215),
                emissiveMap: this.gridTexture
            }, (new THREE.Material).hasOwnProperty("shading") ? this.groundMaterialProps.shading = this.data.flatShading ? THREE.FlatShading : THREE.SmoothShading : this.groundMaterialProps.flatShading = this.data.flatShading, this.groundMaterial = new THREE.MeshLambertMaterial(this.groundMaterialProps));
            var C = this.groundCanvas.getContext("2d"),
                x = this.gridCanvas.getContext("2d");
            if (this.drawTexture(C, p, y), x.fillStyle = "#000000", x.fillRect(0, 0, p, p), this.drawGrid(x, p, y), this.groundTexture.needsUpdate = !0, this.gridTexture.needsUpdate = !0, e) {
        ...
        drawGrid: function (e, t, r) {
            if ("none" != this.data.grid) {
                var i, o, s, a = Math.floor(r / 2),
                    n = t / (r / 2);
                switch (e.fillStyle = this.data.gridColor, this.data.grid) {
                    case "1x1":
                    case "2x2":
                        for ("1x1" == this.data.grid && (a *= 2, n = t / r), i = 0; i < a; i++) s = Math.floor(i * n), e.fillRect(0, s, t, 1), e.fillRect(s, 0, 1, t);
                        break;
                    case "crosses":
                    ...
                    case "dots":
                        for (i = 0; i < a + 1; i++)
                            for (o = 0; o < a + 1; o++) e.beginPath(), e.arc(Math.floor(o * n), Math.floor(i * n), 4, 0, 2 * Math.PI), e.fill();
                        break;
                    case "xlines":
        ...
        drawTexture: function (e, t, i) {
            ...
            var o, s, a, n, d, l, h;
            if ("none" != this.data.groundTexture) switch (this.data.groundTexture) {
                case "checkerboard":
                    e.fillStyle = this.data.groundColor2;
                    var g = Math.floor(i / 2),
                        c = t / (i / 2);
                    for (o = 0; o < g + 1; o += 2)
                        for (var u = 0; u < g + 1; u++) e.fillRect(Math.floor((o + u % 2) * c), Math.floor(u * c), Math.floor(c), Math.floor(c));
                    break;
                case "squares":
                    var m = 16,
                        f = t / m;
                    for (a = new THREE.Color(this.data.groundColor), n = new THREE.Color(this.data.groundColor2), o = 0; o < m * m; o++) s = this.random(o + 3) > .5 ? a.clone() : n.clone(), s.addScalar(.1 * this.random(o + 3) - .05), e.fillStyle = "#" + s.getHexString(), e.fillRect(o % m * f, Math.floor(o / m) * f, f, f);
                    break;
                case "noise":
                    l = e.getImageData(0, 0, t, t), d = l.data, a = new THREE.Color(this.data.groundColor), n = new THREE.Color(this.data.groundColor2);
                    var p = new THREE.Color(n.r - a.r, n.g - a.g, n.b - a.b),
                        y = new r;
                    for (o = 0, u = 0, h = d.length; o < h; o += 4, u++) {
                        var v = y.noise(u % t / t * 3, u / t / t * 3, 0);
                        d[o + 0] = Math.floor(255 * (a.r + p.r * v)), d[o + 1] = Math.floor(255 * (a.g + p.g * v)), d[o + 2] = Math.floor(255 * (a.b + p.b * v))
                    }
                ...
                case "walkernoise":
                    ...
                    E.fillStyle = this.data.groundColor, E.fillRect(0, 0, C, C), l = E.getImageData(0, 0, C, C), d = l.data, a = new THREE.Color(this.data.groundColor), n = new THREE.Color(this.data.groundColor2);
                    var b = [],
                        T = 1e3;
                    for (o = 0; o < T; o++) s = a.clone().lerp(n, Math.random()), b.push({
                        x: Math.random() * C,
                        y: Math.random() * C,
                    ...
                    for (var w = 5e3, S = 0; S < w; S++)
                        for (o = 0; o < T; o++) {
                            ...
                            d[M + 0] = A.r, d[M + 1] = A.g, d[M + 2] = A.b, A.x += Math.floor(3 * Math.random()) - 1, A.y += Math.floor(3 * Math.random()) - 1, A.x >= C && (A.x = A.x - C), A.y >= C && (A.y = A.y - C), A.x < 0 && (A.x = C + A.x), A.y < 0 && (A.y = C + A.y)
                        }
        ...
        getAssetGeometry: function (e) {
            function t(e, t) {
                for (var r = new THREE.Vector3, i = 0, o = e.vertices.length; i < o; i++) r.x = (a.random(i) - .5) * t, r.y = (a.random(i + o) - .5) * t, r.z = (a.random(i + 2 * o) - .5) * t, e.vertices[i].add(r)
            }
            if (!e) return null;
            for (var r, i, o, s = [], a = this, n = 0; n < e.length; n++)
                if ("lathe" == e[n].type) {
                    var d = -99999,
                        l = [];
                    for (o = e[n].vertices, r = 0; r < o.length; r += 2) l.push(new THREE.Vector2(o[r], o[r + 1])), o[r + 1] > d && (d = o[r + 1]);
                    i = new THREE.LatheGeometry(l, e[n].segments || 8), i.applyMatrix((new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(-Math.PI, 0, 0))), i.applyMatrix((new THREE.Matrix4).makeTranslation(0, d, 0)), e[n].noise && t(i, e[n].noise), s.push(i)
                } else if ("extrude" == e[n].type) {
                var h = new THREE.Shape;
                for (o = e[n].vertices, r = 0; r < o.length; r += 2) 0 == r ? h.moveTo(o[r], o[r + 1]) : h.lineTo(o[r], o[r + 1]);
                i = new THREE.ExtrudeGeometry(h, {
                    amount: 1,
                    bevelEnabled: !1
                }), i.applyMatrix((new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(-Math.PI / 2, 0, 0))), e[n].noise && t(i, e[n].noise), s.push(i)
            } else if ("mesh" == e[n].type) {
                i = new THREE.Geometry, o = e[n].vertices;
                for (var g = e[n].faces, c = 0; c < o.length; c += 3) i.vertices.push(new THREE.Vector3(o[c], o[c + 1], o[c + 2]));
                for (var u = 0; u < g.length; u += 3) i.faces.push(new THREE.Face3(g[u], g[u + 1], g[u + 2]));
                this.data.flatShading || e[n].flatShading ? i.computeFaceNormals() : i.computeVertexNormals(), e[n].mirror && i.merge(i, (new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(0, Math.PI, 0))), e[n].noise && t(i, e[n].noise), s.push(i)
            }
            return s
        },
        updateDressing: function () {
            var e = new THREE.Object3D;
            if (this.dressing.setAttribute("visible", "none" != this.data.dressing), "none" != this.data.dressing) {
                var t, r = new THREE.Geometry;
                switch (this.data.dressing) {
                    case "cubes":
                        t = [new THREE.BoxGeometry(1, 1, 1)], t[0].applyMatrix((new THREE.Matrix4).makeTranslation(0, .5, 0));
                        break;
                    case "pyramids":
                        t = [new THREE.ConeGeometry(1, 1, 4, 1, !0)], t[0].applyMatrix((new THREE.Matrix4).makeTranslation(0, .5, 0));
                        break;
                    case "cylinders":
                        t = [new THREE.CylinderGeometry(.5, .5, 1, 8, 1, !0)], t[0].applyMatrix((new THREE.Matrix4).makeTranslation(0, .5, 0));
                        break;
                    default:
                        if (t = this.getAssetGeometry(this.assets[this.data.dressing]), !t) return
                }
                for (var i = 0, o = 88343; i < this.data.dressingAmount; i++, o++) {
                    var s, a = t[Math.floor(this.random(33 + i) * t.length)],
                        n = this.data.dressingScale,
                        d = new THREE.Vector3(this.data.dressingVariance.x, this.data.dressingVariance.y, this.data.dressingVariance.z),
                        l = this.random(o) < this.data.dressingOnPlayArea;
                    s = l ? 15 * this.random(o + 1) : 10 + Math.max(d.x, d.z) + 10 * this.random(o + 1) + this.random(o + 2) * this.STAGE_SIZE / 3;
                    var h = this.random(o + 3) * Math.PI * 2,
                        g = new THREE.Matrix4,
                        c = this.random(o + 4),
                        u = this.data.dressingUniformScale;
                    g.compose(new THREE.Vector3(Math.cos(h) * s, 0, Math.sin(h) * s), (new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0, 1, 0), (this.random(o + 5) - .5) * d.length() * Math.PI * 2), new THREE.Vector3(n + (u ? c : this.random(o + 6)) * d.x, n + (u ? c : this.random(o + 7)) * d.y, n + (u ? c : this.random(o + 8)) * d.z)), r.merge(a, g)
                }
        ...
        createStars: function () {
            for (var e = 2e3, t = new THREE.BufferGeometry, r = new Float32Array(3 * e), i = this.STAGE_SIZE - 1, o = new THREE.Vector3, s = 0; s < r.length; s += 3) o.set(this.random(s + 23) - .5, this.random(s + 24), this.random(s + 25) - .5), o.normalize(), o.multiplyScalar(i), r[s] = o.x, r[s + 1] = o.y, r[s + 2] = o.z;
            t.addAttribute("position", new THREE.BufferAttribute(r, 3)), t.setDrawRange(0, 0);
